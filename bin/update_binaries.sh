...
cd "$HOME"/bin || exit
wget -c https://hpjansson.org/chafa/releases/static/chafa-1.14.0-1-x86_64-linux-gnu.tar.gz -O - | tar xz --strip-components=1 
chmod +x chafa

cd "$HOME"/bin || exit
wget -c https://github.com/gokcehan/lf/releases/download/r31/lf-linux-amd64.tar.gz -O - | tar xz
chmod +x lf
